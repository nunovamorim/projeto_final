...
class SatelliteData:
    ...
    def update(self, data):
        ...
        try:
            ...
            print(f"Updated telemetry: Roll={self.attitude[0]:.2f}°, Pitch={self.attitude[1]:.2f}°, Yaw={self.attitude[2]:.2f}°")
            return True
...
class GroundStationGUI:
        ...
        while True:
            if self.connected and self.socket:
                try:
                    ...
                    print(f"Exception in receive_telemetry: {e}")  # Debug output
    ...
    def update_telemetry_display(self):
        ...
        try:
            ...
            print(f"Error in update_telemetry_display: {e}")  # Debug output
